...
**Configuration lives in `group_vars/all.yml`** — this is where to add apt packages and Brave extension IDs. Tasks read from these lists; avoid hardcoding values in task files.
